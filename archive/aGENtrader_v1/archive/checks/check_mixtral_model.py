"""
Simple script to check if the Mixtral model file exists on EC2
"""
...
def create_test_script():
    """Create a simple test script to verify Mixtral model file"""
    script = """
import os
import sys
...
"""
    ...
    with open("verify_mixtral.py", "w") as f:
        f.write(script)
    
    print("Created verification script: verify_mixtral.py")
