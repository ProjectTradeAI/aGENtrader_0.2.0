...
# Welcome message
log "🔑 Database Configuration Push Tool"
log "==================================================="
...
log_info "✅ Database configuration file created on EC2!"
...
# Check result
if [ $? -eq 0 ]; then
  log_info "✅ Environment variables verified on EC2!"
else
  log_error "❌ Environment variables could not be verified on EC2!"
  exit 1
fi

# Final message
log "✅ Database configuration successfully pushed to EC2!"
